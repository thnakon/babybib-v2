...
<body class="min-h-screen font-sans antialiased bg-white dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100 overflow-x-hidden">
    ...
    <div class="max-w-7xl mx-auto px-6 flex gap-12 pt-12 pb-24 relative">
        <!-- Left Sidebar (Nav) -->
        <aside class="w-64 shrink-0 sticky top-24 h-[calc(100vh-8rem)] overflow-y-auto hidden lg:block custom-scrollbar pr-4">
            <nav class="space-y-8">
                <div>
        ...
        <aside class="w-64 shrink-0 sticky top-24 h-[calc(100vh-8rem)] overflow-y-auto hidden xl:block custom-scrollbar pl-4 border-l border-zinc-100 dark:border-zinc-800">
