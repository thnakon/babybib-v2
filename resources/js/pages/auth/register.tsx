...
const translations = {
    ...
    th: {
        ...
        subtitle: "กรอกข้อมูลของคุณด้านล่างเพื่อเริ่มใช้งาน ScribeHub",
...
export default function Register() {
    ...
    return (
        <div className="min-h-screen bg-scribehub-paper font-overpass text-scribehub-grey antialiased dark:bg-[#0a0a0a] dark:text-gray-300 flex flex-col items-center justify-center p-6 sm:p-10 relative">
            ...
            {/* Register Card */}
            <div className="w-full max-w-sm animate-in fade-in slide-in-from-bottom-10 duration-1000 my-6">
                <div className="flex flex-col items-center mb-6">
                    ...
                    <h1 className="text-xl font-extrabold text-scribehub-blue dark:text-white mb-1">{t.createAccount}</h1>
                ...
                <div className="space-y-4">
                        ...
                        {({ processing, errors }) => (
                            <div className="grid gap-4">
                                <div className="grid gap-1.5">
                                    <Label htmlFor="name" className="text-[11px] font-bold text-gray-700 dark:text-gray-300 ml-1">{t.nameLabel}</Label>
                                ...
                                <div className="grid gap-1.5">
                                    <Label htmlFor="password" className="text-[11px] font-bold text-gray-700 dark:text-gray-300 ml-1">{t.passwordLabel}</Label>
                                    <div className="relative">
                                ...
                                <div className="grid gap-1.5">
                                    <Label htmlFor="password_confirmation" className="text-[11px] font-bold text-gray-700 dark:text-gray-300 ml-1">{t.confirmPasswordLabel}</Label>
                                    <div className="relative">
                                        <ShieldCheck className="absolute left-3 top-1/2 -translate-y-1/2 h-3.5 w-3.5 text-gray-400" />
                                        <Input
                    ...
                    <div className="text-center text-[13px] font-medium text-gray-500">
                        ...
                        <Link href={login()} className="font-bold text-scribehub-blue hover:underline">
                            {t.signIn}
                        </Link>
                    </div>
