...
const translations = {
    en: {
        ...
        subtitle: "Update the details of this bibliographic reference",
    ...
    th: {
        title: "แก้ไขรายการอ้างอิง",
        subtitle: "อัปเดตรายละเอียดของรายการอ้างอิงนี้",
...
export default function ReferencesEdit({ reference }: Props) {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: reference.title.substring(0, 20) + '...', href: `/references/${reference.id}` },
        { title: t.title, href: `/references/${reference.id}/edit` },
    ];
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`${t.title} - ${reference.title}`} />
