...
const translations = {
    en: {
        ...
        subtitle: "Set up a new research project to organize your references",
        ...
        citationStylePlaceholder: "Select a style...",
        styles: {
    ...
    th: {
        title: "สร้างโปรเจกต์",
        subtitle: "ตั้งค่าโปรเจกต์วิจัยใหม่เพื่อจัดระเบียบรายการอ้างอิง",
        ...
        citationStylePlaceholder: "เลือกรูปแบบ...",
        styles: {
            apa7: "APA ฉบับที่ 7",
            mla9: "MLA ฉบับที่ 9",
...
export default function ProjectsCreate() {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: t.title, href: '/projects/create' },
    ];
